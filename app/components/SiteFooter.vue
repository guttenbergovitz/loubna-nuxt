...
const socialLinks = [
  {
    name: 'Facebook',
    url: 'https://facebook.com/loubnaphoto',
    icon: 'mdi:facebook',
    label: 'footer.social.facebook'
  },
  {
    name: 'YouTube',
    url: 'https://youtube.com/@loubnaphoto',
    icon: 'mdi:youtube',
    label: 'footer.social.youtube'
  },
  {
    name: 'Instagram',
    url: 'https://instagram.com/loubnaphoto',
    icon: 'mdi:instagram',
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/company/loubnaphoto',
    icon: 'mdi:linkedin',
    ...
    <div class="o-container">
      <div class="site-footer__content">
        ...
        <div class="site-footer__brand">
          <NuxtLink :to="localePath('index')" class="site-footer__logo">
            Loubna Photo
          </NuxtLink>
